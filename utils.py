...
def load_properties_json(properties_json, label_dir):
    ...
    obj_info['info_part'] = json.load(open('image_generation/data/save_models_1/part_dict.json', 'r'))
    obj_info['colors'] = json.load(open('image_generation/data/colors.json', 'r'))['CSS4_COLORS']
