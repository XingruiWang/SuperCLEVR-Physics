...
sys.path.append('/home/shuo/Super-CLEVR/image_generation/')

import sys

blender_executable_path = sys.argv[0]
print("Blender executable path:", blender_executable_path)
...
# for obj in objs:
#    print(obj.name)
# print(f"obj = {objs.bpy_prop_collection}")
...
color_pth = 'image_generation/data/colors.json'
...
properties_json = 'image_generation/data/properties_cgpart.json'
label_dir = '/mnt/sdb/data/cs/CGPart/labels'
...
for si, obj_name in enumerate(obj_info['info_pth']):
    model_dir = '/mnt/sdb/data/cs/CGPart/'
    ...
    filepath = '/home/shuo/Super-CLEVR/image_generation/data/save_models_1/'+cat_name+'_'+obj_name+'.blend'
    print('####', filepath)
    bpy.ops.wm.save_as_mainfile(filepath=filepath)
    # bpy.ops.wm.previews_batch_generate(filepath)
    # pdb.set_trace()
...
filepath = '/home/shuo/Super-CLEVR/image_generation/data/save_models_1/part_dict.json'
